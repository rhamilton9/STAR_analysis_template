...
// terminal commands to replace all instances of StPIDInterface with 
...
// ----------------------------------------------------------- Class definition
class StPIDInterface : public TObject {
private:
  ...
  // Private class methods -- must be defined and can only be accessed within StPIDInterface.cxx
  void TemplateHelper();
...
public: 
  ...
  ClassDef(StPIDInterface,1)
};

#endif // STAR_StPIDInterface
